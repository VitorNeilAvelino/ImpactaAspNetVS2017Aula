...
namespace Loja.Mvc.Validacoes
{
    public class IdadeMinimaAttribute : ValidationAttribute, IClientValidatable
    {
        ...
        public IdadeMinimaAttribute(int idadeMinina)
        {
            _idadeMinima = idadeMinina;
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            try
            {
                ...
                //var diferencaAnos = (DateTime.Now - dataNascimento);

                if (dataNascimento.AddYears(_idadeMinima) >
                    DateTime.Now)
                {
