...
-- --------------------------------------------------
-- Date Created: 04/27/2018 16:58:57
-- Generated from EDMX file: C:\Users\Vitor Avelino\Source\Repos\ImpactaAspNetVS2017Aula\Loja.Repositorios.SqlServer.ModelFirst\LojaModel.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_FornecedoresCategorias_Fornecedores]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[FornecedoresCategorias] DROP CONSTRAINT [FK_FornecedoresCategorias_Fornecedores];
GO
IF OBJECT_ID(N'[dbo].[FK_FornecedoresCategorias_Categorias]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[FornecedoresCategorias] DROP CONSTRAINT [FK_FornecedoresCategorias_Categorias];
GO
